...
CREATE TABLE `#__node_lang` (
  ...
  `locale` varchar(811) COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `title` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `slug` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `introduction` longtext COLLATE utf8_unicode_ci,
  `content` longtext COLLATE utf8_unicode_ci,
  `content_source` text COLLATE utf8_unicode_ci,
...
EOL
        ...
        $this->addSql(<<<EOL
ALTER TABLE `#__node_metadata`
  ADD CONSTRAINT `fk_node_metadata_node_id` FOREIGN KEY (`node_id`) REFERENCES `#__node` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
EOL
);
        $this->addSql(<<<EOL
ALTER TABLE `#__node_metadata_lang`
