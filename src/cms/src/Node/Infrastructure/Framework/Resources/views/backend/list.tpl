                ...
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right">
                        ...
                        {% for tax in taxonomies %}
                            <a class="dropdown-item dropdown-item-with-icon" href="{{ path('backend.term', { taxonomy_type: tax.type }) }}"><i class="dropdown-icon fas fa-tags"></i> {{ 'taxonomy'|trans({}, tax.translationDomain) }}</a>
                        {% endfor %}
