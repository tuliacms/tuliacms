...
use Tulia\Cms\Website\Domain\WriteModel\WebsiteRepository;
...
class Website extends AbstractController
{
    ...
    public function __construct(Finder $finder, WebsiteRepository $repository, WebsiteRequestExtractor $requestExtractor)
    {
        $this->finder = $finder;
