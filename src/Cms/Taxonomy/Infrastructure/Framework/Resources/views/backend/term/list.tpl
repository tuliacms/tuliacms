    ...
    <div class="pane pane-lead">
        <div class="pane-header">
            <div class="pane-buttons">
                ...
                <a href="{{ path('backend.term.hierarchy', { taxonomy_type: criteria.taxonomy_type }) }}" class="btn btn-secondary btn-icon-only" title="{{ 'hierarchy'|trans({}, 'taxonomy') }}" data-toggle="tooltip"><i class="btn-icon fas fa-sitemap"></i></a>
                <a href="{{ path('backend.term.create', { taxonomy_type: criteria.taxonomy_type }) }}" class="btn btn-success btn-icon-left"><i class="btn-icon fas fa-plus"></i> {{ 'create'|trans }}</a>
            </div>
                        ...
                        <div class="input-group">
                            ...
                            {% if app.request.query.get('q') %}
                                <div class="input-group-append">
                                    <a href="{{ path('backend.term', { taxonomy_type: criteria.taxonomy_type }) }}" class="btn btn-icon-only btn-primary" data-toggle="tooltip" title="{{ 'clearSearch'|trans }}"><i class="btn-icon fas fa-times"></i></a>
                                </div>
                            {% endif %}
                            <div class="input-group-append">
                ...
                {% for term in terms %}
                    <tr data-element-name="{{ term.title }}" data-element-id="{{ term.id }}">
                        ...
                        <td data-label="{{ 'title'|trans }}" class="col-title">
                            <a href="{{ path('backend.term.edit', { taxonomy_type: term.type, id: term.id }) }}" class="link-title" title="{{ term.title }}">
                        ...
                        <td data-label="{{ 'actions'|trans }}" class="col-actions">
                            <div class="actions-box">
                                ...
                                <div class="btn-group">
                                    <a href="{{ path('backend.term.edit', { taxonomy_type: term.type, id: term.id }) }}" class="btn btn-secondary btn-icon-only btn-main-action">
            ...
            new Tulia.ElementsActions({
                actions: {
                    delete: {
                        ...
                        action: '{{ path('backend.term.delete', { taxonomy_type: taxonomyType.type, _token: csrf_token('term.delete') }) }}',
                    },
                }
            });
