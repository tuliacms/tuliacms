...
namespace Tulia\Cms\User\UI\Web\Controller;
...
use Tulia\Cms\User\UI\Web\Form\UserForm\UserFormManager;
...
class User extends AbstractController
{
    ...
    {
        return $this->redirect('backend.user.list');
    }
    ...
    public function create(
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirect('backend.user.edit', [ 'id' => $user->getId() ]);
        }
