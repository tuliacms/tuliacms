...
use Tulia\Cms\Widget\UserInterface\Web\Backend\Form\ModelTransformer\WidgetIdModelTransformer;
...
class WidgetForm extends AbstractFormSkeletonType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        ...
        $builder->get('id')->addModelTransformer(new WidgetIdModelTransformer());
    }
